...
export default class TestScope {
  ...
  constructor(component, waitTime, startDelay, shouldSendReport, reportPort) {
  ...
  sendReport(report) {
    const url = `http://127.0.0.1:${this.reportPort}/report`;
    console.log(`sending report via url ${url}`);
